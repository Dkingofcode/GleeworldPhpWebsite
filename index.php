...
<body>
    ...
    <div style="overflow: hidden;" class="container">
        ...
        <div style="display: flex;  align-items: center;" class="row">
            <div class="col-md-6">
                <h1 style="font-size: 35px;">Medication Access Made Easy</h1>
        ...
        <div class="IntroHead">  
           ...
           <div class="IntroText">
            ...
            <div class="col-md-6">
                <p>
                As a telepharmacy and delivery startup, we dedicated
        ...
        <div class="row">
         ...
         <div  class='News'>
          ...
          <!---  Achievements  -->
           ...
           <div style="display: flex; " class='Patners carousel-container'>
  ...
  <!-- custom boostrap slider  --->
   <?php include 'carousel.php'; ?>
        ...
        <!-- <div class="testimonials">
            ...
            <q>
              Gleeworld Pharmacy has transformed our operations. Their technology tools are a game-changer for small pharmacies like ours.
                </q>
              <p>Kevin</p>
          ...
          <q> "Great Service! Gleeworld ensures that we never run out of stock, and their team is always helpful.</q>  
           ...
           <q> The delivery is fast, and the customer service is outstanding. Our pharmacy has never been more efficient.</q>
            ...
            <p>"Gleeworld Pharmacy has transformed our operations..."</p>
        </div>
     -->
        <!-- Contact Form -->
        <div class="contact">
